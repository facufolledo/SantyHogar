...
export default function MyAddresses() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Modal - Sin AnimatePresence para evitar problemas de z-index */}
      {modalOpen && (
        <div
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={closeModal} disabled={submitting}><X size={20} className="text-gray-400" /></button>
            </div>
            <form onSubmit={handleSave} className="space-y-3">
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={closeModal} disabled={submitting} className="btn-secondary flex-1 text-sm py-2.5 disabled:opacity-50 disabled:cursor-not-allowed">Cancelar</button>
