...
async def create_checkout_preference(request: CheckoutRequest):
    ...
    webhook_url = f"{config.public_api_url}/api/webhooks/mercadopago"
    ...
    # Crear preferencia
    # auto_return: 'approved' hace que MercadoPago redirija automáticamente
    # a la back_url de éxito después de un pago aprobado (sin que el usuario
    # deba tocar el botón "Volver al sitio")
    preference_data = {
        "items": mp_items,
        "payer": {
