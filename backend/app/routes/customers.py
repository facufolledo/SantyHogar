...
async def list_addresses(
    ...
    try:
        addresses = await customer_service.get_customer_addresses(customer_id)
        return addresses
    except DatabaseError as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def create_address(
    ...
    try:
        address = await customer_service.create_address(customer_id, body)
        return address
    except DatabaseError as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def update_address(
    ...
    try:
        address = await customer_service.update_address(customer_id, address_id, body)
        return address
    except DatabaseError as e:
...
async def delete_address(
    ...
    try:
        await customer_service.delete_address(address_id)
    except DatabaseError as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=str(e),
...
async def list_favorites(
    ...
    """Lista todos los favoritos de un cliente."""
    try:
        favorites = await customer_service.get_customer_favorites(customer_id)
        return favorites
    except DatabaseError as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def add_favorite(
    ...
    try:
        favorite = await customer_service.add_favorite(customer_id, body.productId)
        return favorite
    except DatabaseError as e:
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
